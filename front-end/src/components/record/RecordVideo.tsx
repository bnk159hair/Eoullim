...
const VideoModal: React.FC<VideoModalProps> = ({
  ...
  const guideScript: { [key: string]: string } = {
    ...
    '4': '나는 저번 주에 형이랑 짜장면을 시켜 먹었는데 정말 맛있었어. 너희는 무슨 음식을 제일 좋아해? 나는 평소에 친구들이랑 숨바꼭질 하는 게 제일 재밌어. 너희는 친구들이랑 뭐하고 놀 때 제일 재밌어?',
    '5': '나는 의사 선생님이 되는 게 꿈이야. 아픈 사람들을 치료해주는 멋진 의사 선생님이 될 거야. 너희는 꿈이 뭐야?',
    '6': '나는 요즘 가수 중에 뉴진스가 제일 좋아! 너희는 좋아하는 가수 있어?',
    '7': '나는 학교에서 배우는 과목 중에 수학 수업을 제일 좋아해. 너희는 무슨 과목을 가장 좋아해?',
    '8': '나 속상한 일이 있었는데 들어줄래?? 어제, 동생이랑 놀다가 싸워서 엄마한테 혼났거든. 근데 동생이 잘못한건데 엄마가 나만 혼낸 거 있지? 너무 슬펐어... 너희는 슬펐던 적이 있어?',
    '9': '나는 방학에 가족들이랑 바닷가에 다녀왔던 게 가장 재밌었어. 너희는 가족들과 어디 놀러갔을 때 가장 좋았어? 가장 즐거웠던 기억을 말해줘.',
    '10': '나는 이번 주말에 엄마 아빠랑 놀이공원에 놀러가고 싶어! 너희는 엄마 아빠랑 뭐하고 싶어?',
    '11': '나는 엄마 아빠가 나한테 사랑해 라고 할 때 가장 좋아! 너희는 엄마 아빠가 뭐라고 말해줄 때 가장 좋아?',
    '12': '오늘 너희를 만나서 정말 즐거웠어. 너희는 새로운 친구를 만나보니 어때? 재밌었어?   우리 다음에 또 만나자~~ 안녕~~!',
  };
